package com.example.recursosandroidlocation
...
class MapsActivity : AppCompatActivity(),
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        map = googleMap
        map.uiSettings.isZoomControlsEnabled = true //HABILITAR ZOOM
        map.setOnMarkerClickListener(this) //HABILITA MENU PARA DEFINIR ROTAS OU MARKER NO CLICK
...
//        ))
    ...
    //REMOVE LOCATION UPDATE IF APPLICATTION IS PAUSED
